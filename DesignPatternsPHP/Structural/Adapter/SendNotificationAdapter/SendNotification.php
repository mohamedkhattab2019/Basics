...
namespace DesignPatternsPHP\Structural\Adapter\SendNotificationAdapter;
/**
 ...
 * API.
 */
class SlackNotification implements SendNotification{
    private $slack;
    private $chatId;
 ...
 */
function clientCode(SendNotification $notification)
{
...
$notification = new EmailNotification("mkhattab@c3s.co");

clientCode($notification);
echo "\n\n";

echo "The same client code can work with other classes via adapter:\n";
$slackApi = new SlackApi("mkhattab.com","XXXXX");

$slackNotification = new SlackNotification($slackApi,"zeinab.com");

...
namespace Creational\PtotoType;

/**
 * Prototype.
 */
class ProtoTypePagePost
{
    private $title;
    private $body;
...
class Author
{
    ...
    public function addToPage(ProtoTypePagePost $page): void
    {
        $this->pages[] = $page;
    }
}
...
function clientCode()
{
    ...
    $page = new ProtoTypePagePost("Tip of the day", "Keep calm and carry on.", $author);

    // ...


    $page->addComments("Nice tip, thanks!");
    $draft = clone $page;
    // $draft = clone $page;
...
//prototype design pattern example in php?